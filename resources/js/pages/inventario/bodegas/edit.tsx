...
const breadcrumbs = (id: number): BreadcrumbItem[] => [
    ...
    { title: 'Editar', href: `/inventario/bodegas/${id}/edit` },
];

export default function BodegaEdit({ bodega }: Props) {
    ...
    function submit(e: React.FormEvent) {
        e.preventDefault();
        put(`/inventario/bodegas/${bodega.id}`);
    }

    return (
        <AppLayout breadcrumbs={breadcrumbs(bodega.id)}>
            <Head title="Editar Bodega" />
