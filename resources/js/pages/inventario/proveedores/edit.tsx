...
const breadcrumbs = (id: number): BreadcrumbItem[] => [
    ...
    { title: 'Editar', href: `/inventario/proveedores/${id}/edit` },
];

export default function ProveedorEdit({ proveedor }: Props) {
    ...
    function submit(e: React.FormEvent) {
        e.preventDefault();
        put(`/inventario/proveedores/${proveedor.id}`);
    }
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs(proveedor.id)}>
            ...
            <div className="flex h-full flex-1 flex-col gap-6 p-6">
                <h1 className="text-2xl font-bold text-foreground">Editar Proveedor</h1>
